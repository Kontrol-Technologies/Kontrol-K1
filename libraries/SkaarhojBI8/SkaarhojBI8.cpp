...
bool SkaarhojBI8::begin(uint8_t address)	{
	return begin(address, false, true);
}
bool SkaarhojBI8::begin(uint8_t address, bool reverseButtons) {
	return begin(address, reverseButtons, true);
}
bool SkaarhojBI8::begin(uint8_t address, bool reverseButtons, bool extendedBicolor) {
	...
	_extendedBicolor = false;	// If set, the board is Bicolor and has 16 buttons on the input.
	_B1Alt = false;	
	_RGBbuttons = false;
...
void SkaarhojBI8::setButtonType(uint8_t type)	{
	...
	switch(type)	{
		...
		_colorBalanceRed[1] = 40;
		_colorBalanceRed[2] = 0;
		_colorBalanceRed[3] = 40;
		...
		_colorBalanceGreen[2] = 100;
		_colorBalanceGreen[3] = 0;
		_colorBalanceGreen[4] = 50;
		_colorBalanceGreen[5] = 0;
		...
		default: 	// NKK buttons
		_colorBalanceRed[0] = 0;
		_colorBalanceRed[1] = 20;
		_colorBalanceRed[2] = 0;
		_colorBalanceRed[3] = 60;
		_colorBalanceRed[4] = 8;
		...
		_colorBalanceGreen[0] = 0;
		_colorBalanceGreen[1] = 100;	// Most recent batch of buttons require this - maybe find another way to create this balance?
		_colorBalanceGreen[2] = 100;
		_colorBalanceGreen[3] = 0;
        _colorBalanceGreen[4] = 100;	// Most recent batch of buttons require this - maybe find another way to create this balance?
		_colorBalanceGreen[5] = 30;	// Most recent batch of buttons require this - maybe find another way to create this balance?
		_colorBalanceGreen[6] = 0;
		_colorBalanceGreen[7] = 0;
		_colorBalanceGreen[8] = 0;
...
void SkaarhojBI8::testSequence() { testSequence(4); }
