...
void SkaarhojUtils::uniDirectionalSlider_init(){
	uniDirectionalSlider_init(1, 0, 0, A0);
}
...
bool SkaarhojUtils::uniDirectionalSlider_hasMoved()	{
	...
	if (sliderValue >= _uniDirectionalSlider_previousSliderValue+_uniDirectionalSlider_sliderTolerance || sliderValue <= _uniDirectionalSlider_previousSliderValue-_uniDirectionalSlider_sliderTolerance)  {
		...
		if (!_uniDirectionalSlider_disableUnidirectionality && sliderValue <= _uniDirectionalSlider_previousSliderValue-_uniDirectionalSlider_sliderTolerance && (_uniDirectionalSlider_previousSliderValue==-1 || _uniDirectionalSlider_previousSliderValue>915-_uniDirectionalSlider_sliderHighEndOffset))  {
			_uniDirectionalSlider_sliderDirectionUp = false;
		}

		_uniDirectionalSlider_previousSliderValue = sliderValue;

		int transitionPosition = (long)1000*(long)(sliderValue-_uniDirectionalSlider_sliderLowEndOffset)/(long)(915-_uniDirectionalSlider_sliderLowEndOffset-_uniDirectionalSlider_sliderHighEndOffset);
	...
	if (index <=1)	{
		...
		if (potValue >= _joystick_previousValue[index]+_joystick_tolerance || potValue <= _joystick_previousValue[index]-_joystick_tolerance)  {
			...
			if (potValue<0)	{
				...
				joystickPosition = (long)100*(long)joystickPosition/(long)(915-_joystick_centerValue[index]);
			}
