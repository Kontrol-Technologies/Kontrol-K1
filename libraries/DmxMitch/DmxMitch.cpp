...
static uint8_t dmxPin = 3; // Defaults to output on pin 3! DMX shield
...
*/
#warning "DmxMitch does not support this CPU"
#endif
...
*/
void DmxMitchClass::usePin(uint8_t pin) {
  dmxPin = pin;
...
*/
void DmxMitchClass::maxChannel(int channel) {
...
*/
void DmxMitchClass::write(int address, uint8_t value)
{
dmxWrite(address, value);
}
DmxMitchClass DmxMitch;
